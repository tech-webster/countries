...
export const BA: Country = {
  ...
  capital: "Sarajevo",
  continent: "Europe",
  currency: { code: "BAM", symbol: "KM", name: "Bosnia and Herzegovina Convertible Mark" },
...
export const BF: Country = {
  ...
  capital: "Ouagadougou",
  continent: "Africa",
  currency: { code: "XOF", symbol: "Fr", name: "West African CFA Franc" },
  timezones: ["Africa/Ouagadougou"],
};
export const BG: Country = {
  code: "BG",
  alpha3: "BGR",
  label: "Bulgaria",
  phone: "359",
...
export const BZ: Country = {
  ...
  capital: "Belmopan",
  continent: "North America",
  currency: { code: "BZD", symbol: "$", name: "Belize Dollar" },
...
export const CD: Country = {
  ...
  capital: "Kinshasa",
  continent: "Africa",
  currency: { code: "CDF", symbol: "Fr", name: "Congolese Franc" },
...
export const CF: Country = {
  ...
  capital: "Bangui",
  continent: "Africa",
  currency: { code: "XAF", symbol: "Fr", name: "Central African CFA Franc" },
...
export const DO: Country = {
  ...
  continent: "North America",
  currency: { code: "DOP", symbol: "$", name: "Dominican Peso" },
...
export const GY: Country = {
  ...
  capital: "Georgetown",
  continent: "South America",
  currency: { code: "GYD", symbol: "$", name: "Guyanese Dollar" },
...
export const JM: Country = {
  ...
  capital: "Kingston",
  continent: "North America",
  currency: { code: "JMD", symbol: "$", name: "Jamaican Dollar" },
...
export const KG: Country = {
  ...
  capital: "Bishkek",
  continent: "Asia",
  currency: { code: "KGS", symbol: "с", name: "Kyrgyzstani Som" },
...
export const KP: Country = {
  ...
  capital: "Pyongyang",
  continent: "Asia",
  currency: { code: "KPW", symbol: "₩", name: "North Korean Won" },
...
export const KY: Country = {
  ...
  capital: "George Town",
  continent: "North America",
  currency: { code: "KYD", symbol: "$", name: "Cayman Islands Dollar" },
...
export const MN: Country = {
  ...
  capital: "Ulaanbaatar",
  continent: "Asia",
  currency: { code: "MNT", symbol: "₮", name: "Mongolian Togrog" },
...
export const MO: Country = {
  ...
  capital: "Macao",
  continent: "Asia",
  currency: { code: "MOP", symbol: "P", name: "Macanese Pataca" },
  timezones: ["Asia/Macau"],
};
export const MP: Country = {
  code: "MP",
  alpha3: "MNP",
...
export const NA: Country = {
  ...
  capital: "Windhoek",
  continent: "Africa",
  currency: { code: "NAD", symbol: "$", name: "Namibian Dollar" },
  timezones: ["Africa/Windhoek"],
};
export const NC: Country = {
  code: "NC",
  alpha3: "NCL",
  label: "New Caledonia",
  phone: "687",
  capital: "Noumea",
  continent: "Oceania",
  currency: { code: "XPF", symbol: "Fr", name: "CFP Franc" },
...
export const QA: Country = {
  ...
  capital: "Doha",
  continent: "Asia",
  currency: { code: "QAR", symbol: "﷼", name: "Qatari Riyal" },
  timezones: ["Asia/Qatar"],
};
export const RE: Country = {
  code: "RE",
  alpha3: "REU",
  label: "Reunion",
  phone: "262",
...
export const RW: Country = {
  ...
  capital: "Kigali",
  continent: "Africa",
  currency: { code: "RWF", symbol: "Fr", name: "Rwandan Franc" },
...
export const SB: Country = {
  ...
  capital: "Honiara",
  continent: "Oceania",
  currency: { code: "SBD", symbol: "$", name: "Solomon Islands Dollar" },
...
export const SC: Country = {
  ...
  capital: "Victoria",
  continent: "Africa",
  currency: { code: "SCR", symbol: "Rs", name: "Seychellois Rupee" },
...
export const SH: Country = {
  ...
  capital: "Jamestown",
  continent: "Africa",
  currency: { code: "SHP", symbol: "£", name: "Saint Helena Pound" },
...
export const ST: Country = {
  ...
  capital: "Sao Tome",
  continent: "Africa",
  currency: { code: "STN", symbol: "Db", name: "Sao Tome and Principe Dobra" },
...
export const SY: Country = {
  ...
  capital: "Damascus",
  continent: "Asia",
  currency: { code: "SYP", symbol: "£", name: "Syrian Pound" },
...
export const TO: Country = {
  ...
  capital: "Nuku'alofa",
  continent: "Oceania",
  currency: { code: "TOP", symbol: "T$", name: "Tongan Pa'anga" },
...
export const TT: Country = {
  ...
  continent: "North America",
  currency: { code: "TTD", symbol: "$", name: "Trinidad and Tobago Dollar" },
...
export const TW: Country = {
  ...
  capital: "Taipei",
  continent: "Asia",
  currency: { code: "TWD", symbol: "$", name: "New Taiwan Dollar" },
...
export const TZ: Country = {
  ...
  capital: "Dodoma",
  continent: "Africa",
  currency: { code: "TZS", symbol: "Sh", name: "Tanzanian Shilling" },
...
export const UG: Country = {
  ...
  capital: "Kampala",
  continent: "Africa",
  currency: { code: "UGX", symbol: "Sh", name: "Ugandan Shilling" },
  timezones: ["Africa/Kampala"],
};
export const UM: Country = {
  code: "UM",
  alpha3: "UMI",
...
export const VE: Country = {
  ...
  capital: "Caracas",
  continent: "South America",
  currency: { code: "VES", symbol: "Bs.S", name: "Venezuelan Bolivar Soberano" },
  timezones: ["America/Caracas"],
};
export const VG: Country = {
  code: "VG",
  alpha3: "VGB",
...
export const WS: Country = {
  ...
  capital: "Apia",
  continent: "Oceania",
  currency: { code: "WST", symbol: "T", name: "Samoan Tala" },
  timezones: ["Pacific/Apia"],
};
export const XK: Country = {
  code: "XK",
  alpha3: "XKX",
  label: "Kosovo",
  phone: "383",
